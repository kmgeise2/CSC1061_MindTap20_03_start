...
// Because there are n nodes, we use an array, A, of size n, 
// such that A[i] is a reference variable pointing to the first node 
// of the linked list containing the vertices to which  is adjacent. 
...
protected:
    ...
    unorderedLinkedList<int>* graph; // adjacency linked list 
...
void graphType::createGraph()
{
    ...
    cout << "Enter input file name (Ch20_Ex2Data.txt or Ch20_Ex14Data.txt): ";
    cin >> fileName;
    cout << endl;
    ...
    // For each vertex, read data from file and update an
    // unordered linked list with adjacent vertices
    ...
    for (index = 0; index < gSize; index++)
    {
        ...
        {
            // For each vertex, build an adjacency linked list
            graph[vertex].insertLast(adjacentVertex);

            // read the next vertex's data
            infile >> adjacentVertex;
        } //end while
    } // end for
